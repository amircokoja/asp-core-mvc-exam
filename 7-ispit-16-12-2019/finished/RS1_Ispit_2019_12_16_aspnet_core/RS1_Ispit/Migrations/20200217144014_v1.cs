        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ClanKomisije1Id = table.Column<int>(nullable: true),
                    ClanKomisije2Id = table.Column<int>(nullable: true),
                    ClanKomisije3Id = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ImaPravoNaPopravni = table.Column<bool>(nullable: false),
                    OdjeljenjeStavkaId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PopravniUcenik", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PopravniUcenik_OdjeljenjeStavka_OdjeljenjeStavkaId",
                        column: x => x.OdjeljenjeStavkaId,
                        principalTable: "OdjeljenjeStavka",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PopravniUcenik_PopravniIspit_PopravniId",
                        column: x => x.PopravniId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PopravniUcenik_OdjeljenjeStavkaId",
                table: "PopravniUcenik",
                column: "OdjeljenjeStavkaId");

            migrationBuilder.CreateIndex(
                name: "IX_PopravniUcenik_PopravniId",
                table: "PopravniUcenik",
                column: "PopravniId");
